...
\section{Conclusion}
While a complete derivation of the microscale model for electrochemical batteries is far involved and nuanced than the material presented in this paper. The hope has been that this paper helps to contextualize and explain the process behind the basics of the microscale model derivation. The result of this derivation is a system of partial differential equations that which couple together to form the basis for the industry standard Doyle-Fuller-Newman model.


\section*{Acknowledgments}
\noindent I would like to thank Dr. Lin  (and his entire research lab) for their combined mentorship in exploring the world of electrochemical battery models and estimation theory.
